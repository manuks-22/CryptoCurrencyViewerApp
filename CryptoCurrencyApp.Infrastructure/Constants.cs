namespace CryptoCurrencyApp.Infrastructure
{
    public class Constants
    {
        ...
        private const string coinMarketCapApiKey = @"e0040278-0335-4a25-8920-eaadc6b49394";
        ...
        private const string currencyExchangeApiKey = @"BMnOPIQJkAPwhfVy12YRzk5Va1GAY4q7";
